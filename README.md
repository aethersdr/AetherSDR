...
- **Six client-side noise-reduction engines** — NR2 (spectral), RN2 (RNNoise), NR4 (libspecbleach), DFNR (DeepFilterNet3), BNR (NVIDIA GPU AI — runs locally on an NVIDIA GPU *or* against a remote NIM service, even with no local GPU; see [`docs/nvidia-bnr.md`](docs/nvidia-bnr.md)), and MNR (macOS)
