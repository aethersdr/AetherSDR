...
| `hasNetworkConfigurationReadback` | ✅ | ❌ | ❌ | `IcomCivBackend` | Declares that the backend can read radio-authoritative network information. Icom is profile-driven: IC-9700 uses documented `1A 05 0139–0141` plus Network Name `0144`; IC-7300MK2 uses `0102–0104` plus `0107`; IC-705 is ❌ because its CI-V guide does not expose these WLAN settings. Network Name publishes through the neutral nickname field. |
