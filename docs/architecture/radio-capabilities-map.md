...
| `hasWaveforms` | ✅ | ❌ | ❌ | `MainWindow::applyCapabilitiesToUi`, `Ax25HfPacketDecodeDialog` | File ▸ Waveforms… and the AetherModem D-STAR tab (ThumbDV helper needs a SmartSDR D-STAR waveform). Icom/HL2/Sim/ANAN/RTL declare false; disconnected restores the tab |
