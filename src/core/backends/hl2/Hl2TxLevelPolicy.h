...
//
// 50 is unity, and stays unity now that TransmitModel restores m_micLevel from
// PhoneMicLevel at startup: 50 is still the model's own default and therefore
// still what an operator who has never touched the slider is restored to, so
